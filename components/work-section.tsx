...
const projects = [
  {
    ...
    gradient: "from-blue-500/20 via-pink-300/20 to-pink-500/20",
  ...
  },
  {
    ...
    gradient: "from-pink-300/20 via-pink-500/20 to-orange-500/20",
  ...
  },
  {
    ...
    gradient: "from-indigo-500/20 via-violet-500/20 to-pink-300/20",
  ...
  return (
    <section id="work" className="pt-24 pb-8 md:pt-28 md:pb-12 lg:pt-32 lg:pb-16 relative overflow-hidden scroll-mt-20">
      ...
      <div className="absolute inset-0 opacity-30">
        <motion.div
          className="absolute top-1/4 left-1/4 w-64 h-64 bg-gradient-to-r from-pink-300/10 to-blue-500/10 rounded-full blur-3xl"
          animate={{
            x: [0, 50, 0],
            y: [0, -30, 0],
            scale: [1, 1.1, 1],
              ...
              <div className="space-y-1">
                {services.map((service, index) => (
                  ...
                  >
                    ...
                    <div
                      onClick={() => toggleFolder(service.title)}
                      className={`flex items-center gap-2 p-1.5 rounded-lg cursor-pointer transition-all duration-200 hover:bg-secondary/10 hover:border-l-2 hover:border-pink-300/50 group/item ${
                        service.isPriority ? 'bg-pink-300/5 border border-pink-300/20' : 
                    ...
                    >
                      ...
                      <div className="relative">
                        {openFolder === service.title ? (
                          <Folder className={`w-5 h-5 ${service.isPriority ? 'text-pink-300' : service.isAdditional ? 'text-green-500' : 'text-primary'}`} />
                        ) : (
                          <Folder className={`w-5 h-5 ${service.isPriority ? 'text-pink-300' : service.isAdditional ? 'text-green-400' : 'text-muted-foreground'} group-hover/item:text-pink-300 transition-colors duration-200`} />
                        )}
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-1">
                          <span className="font-mono text-xs text-foreground group-hover/item:text-pink-300 transition-colors duration-200 truncate">
                            {service.filename}
                          </span>
                          <ChevronDown className={`w-3 h-3 text-muted-foreground group-hover/item:text-pink-300 transition-all duration-200 ${
                      ...
                      {/* Hover indicator */}
                      <div className="w-2 h-2 rounded-full bg-pink-300 opacity-0 group-hover/item:opacity-100 transition-opacity duration-200" />
                    </div>
