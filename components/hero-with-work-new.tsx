...
// Remove unnecessary shuffle function and simplify tech stack grid
  ...
  return (
    <div className="grid grid-cols-6 sm:grid-cols-8 lg:grid-cols-10 gap-2">
      {techStack.map((tech) => (
        <div
          key={tech.alt}
          className="w-8 h-8 bg-background/60 backdrop-blur-sm rounded-lg p-1.5 border border-border/20 flex items-center justify-center"
    ...
    <section className="min-h-[90vh] flex items-center relative px-4 py-16">
      <div className="w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
        ...
        <div className="space-y-6 lg:space-y-8">
          {/* Show the name only when not in projects view - Updated */}
          {viewState !== 'projects' && (
              ...
              >
                <div className="space-y-6">
                  {workData.map((project, index) => (
                    ...
                    >
                      <h3 
                        className="text-5xl sm:text-6xl lg:text-7xl xl:text-8xl font-bold tracking-tight leading-tight text-transparent"
                        style={{
        ...
        <div className="space-y-6 glass-backdrop">
          {/* Now Card */}
          <motion.div
          ...
          >
            <div className="p-6">
              <div className="flex items-start gap-4">
                <div className="p-3 bg-green-500/10 rounded-xl backdrop-blur-sm border border-green-500/20">
                  <Clock className="w-6 h-6 text-green-400" />
                </div>
                <div>
                  <h3 className="font-semibold text-white mb-1">Now</h3>
          ...
          >
            <div className="p-6">
              <div className="flex items-start gap-4">
                <div className="p-3 bg-purple-500/10 rounded-xl backdrop-blur-sm border border-purple-500/20">
                  <Code className="w-6 h-6 text-purple-400" />
                </div>
                <div>
                  <h3 className="font-semibold text-white mb-1">Building</h3>
                  <p className="text-sm text-gray-200 leading-relaxed">
            ...
            <div className="p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-200">New York City, NY</p>
                </div>
              </div>
            </div>
          </motion.div>
